...
sub renderFrame {
  ...
  system("gunzip ../build/density_export_".$number.".pbrt.gz");
  ...
  # print "/Users/Caleb/Development/OpenSource/pbrt/src/build/Debug/pbrt --verbose --outfile ".$thisRender." ".$thisPBRT."\n";
  # system("/Users/Caleb/Development/OpenSource/pbrt/src/build/Debug/pbrt --verbose --outfile ".$thisRender." ".$thisPBRT);
  print "/Users/Caleb/Development/OpenSource/pbrt/src/bin/pbrt --verbose ".$thisPBRT."\n";
  system("/Users/Caleb/Development/OpenSource/pbrt/src/bin/pbrt --verbose ".$thisPBRT);

  # rezip the volume file
  system("gzip ../build/density_export_".$number.".pbrt");
